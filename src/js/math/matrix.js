...
export function Matrix3(copySource) {
	if (copySource) {
		this.copyFrom(copySource);
	}
}

Matrix3.prototype.loadIdentity = function() {
...
Matrix3.prototype.extractEulerAngles = function(order) {
	return Tarumae.MathFunctions.getEulerAnglesFromMatrix(this, order);
};

Matrix3.prototype.mulInv = function(m1) {
	var m2 = this;
	var m3 = new Matrix3();
...
Matrix3.prototype.equals = function(m2) {
...
export function Matrix4(copySource) {
	if (copySource) {
		this.copyFrom(copySource);
	}
 ...
 */
Matrix4.prototype.rotate = function(x, y, z, order) {
...
Matrix4.prototype.rotateCombine = function(x, y, z) {
...
Matrix4.prototype.canInverse = function() {
	var
...
Matrix4.prototype.mul = function(m2) {
	var m1 = this;
	var m3 = new Matrix4();
...
Matrix4.prototype.mulInv = function(m1) {
	var m2 = this;
	var m3 = new Matrix4();
...
Matrix4.prototype.equals = function(m2) {
...
Matrix4.prototype.perspective = function(angle, widthRate, near, far) {
...
Matrix4.prototype.extractEulerAngles = function() {
	var
...
Matrix4.prototype.extractLookAtVectors = function() {
	return {
