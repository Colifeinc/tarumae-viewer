...
Object.defineProperties(Archive.prototype, {
	onChunkReady: {
...
function ArchiveChunk(uid, format, flags, offset, length, buffer) {
	this.uid = uid;
	this.format = format;
	this.flags = flags;
	this.offset = offset;
...
Object.defineProperties(ArchiveChunk.prototype, {
	data: {
		get: function() {
